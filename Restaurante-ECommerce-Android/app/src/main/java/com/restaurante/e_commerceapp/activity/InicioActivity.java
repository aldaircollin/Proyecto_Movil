...
import com.restaurante.e_commerceapp.databinding.ActivityInicioBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.appBarInicio.fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Uri uri = Uri.parse("https://api.whatsapp.com/send/?phone=51917004194&text=Hola%2C+deseo+hacer+un+pedido.&app_absent=0");
